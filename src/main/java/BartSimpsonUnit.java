...
public class BartSimpsonUnit extends Recruiter {
  ...
  public BartSimpsonUnit(char symbol, String name, String teamColor, double health, double healthModifier,
      double damage, double damageModifier, int luck, int xCor, int yCor, int movement, int movementModifier,
      int numRecruits, int numTimesSpawned, boolean distract, boolean recruit) {
    super(symbol, name, teamColor, health, healthModifier, damage, damageModifier, luck, xCor, yCor, movement,
        movementModifier, numRecruits);
  ...
  /**
   * Checks to see if the unit can be distracted, and prints out that it is
   * distracted.
   */
