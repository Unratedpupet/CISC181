...
public class Blademaster extends Attacker{
    ...
    public Blademaster(char symbol, String name, String teamColor, double health, double healthModifier,
                       double damage, double damageModifier, int luck, int xCor, int yCor, int movement,
                       int movementModifier, int numAttacks, boolean battleFocus) {
        super(symbol, name, teamColor, health, healthModifier, damage, damageModifier, luck,
                xCor, yCor, movement, movementModifier, numAttacks);
    ...
    public Blademaster spawn() {
        Blademaster bm = new Blademaster('m', "Blademaster", "Blu",
                100.0, 5.0, 25.0, 10.0,
                0, 1, 1, 1, 1, 0, false);
        return bm;
    }
